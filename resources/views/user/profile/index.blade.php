        ...
        <div class="rounded-[32px] border border-white/10 bg-[#151A27] p-8">
            ...
            <div class="mb-8 flex items-center gap-5">
                ...
                <div>
                    ...
                    <p class="mt-2 text-gray-400">manh@example.com</p>
                </div>
            </div>
            ...
            <div class="grid gap-5 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input value="manh@example.com" class="w-full rounded-2xl border border-white/10 bg-[#080A12] px-5 py-4 outline-none">
                </div>
