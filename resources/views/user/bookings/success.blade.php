            ...
            <div class="bg-dark-main border border-dark-border rounded-2xl p-6 mb-8 text-left relative overflow-hidden">
                ...
                <div class="border-b border-dashed border-dark-border pb-4 mb-4 flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-xl font-bold text-brand-start font-mono">MMT-2026-0001</p>
                    </div>
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=60x60&data=MMT-2026-0001&color=FF3D57&bgcolor=080A12" alt="QR Code" class="w-12 h-12 rounded bg-white p-1">
                </div>

                <div class="space-y-3 text-sm">
                    <div class="flex justify-between">
                        <span class="text-text-sub">Phim</span>
                        <span class="text-white font-medium text-right max-w-[60%]">Thanh Gươm Diệt Quỷ</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-text-sub">Rạp</span>
                        <span class="text-white font-medium text-right">MovieMate Cầu Giấy</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-text-sub">Thời gian</span>
                        <span class="text-white font-medium text-right">09:30 - Thứ 3, 19/05</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-text-sub">Ghế</span>
                        <span class="text-white font-bold text-right">F7, F8</span>
                    </div>
                </div>
            </div>

            <p class="text-sm text-text-sub mb-8">
                <i class="ph-fill ph-envelope-simple text-brand-start"></i> Vé điện tử đã được gửi đến email <br> <span class="text-white font-medium mt-1 inline-block">manh@example.com</span>
            </p>
