...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 h-[calc(100vh-80px)]">
        <div class="app-card border app-border rounded-3xl h-full flex overflow-hidden shadow-2xl">
            ...
            <!-- Sidebar -->
            <div class="w-72 border-r app-border flex-col hidden md:flex app-secondary">
                ...
                <div class="p-5 flex-grow overflow-y-auto hide-scrollbar">
                    ...
                    <div class="space-y-1.5">
                        <button class="w-full text-left p-3 rounded-xl app-card border app-border text-sm app-muted hover:app-text hover:border-ai-start/50 transition-colors">
            ...
            <div class="flex-grow flex flex-col min-w-0">
                <!-- Header -->
                <div class="h-16 border-b app-border flex items-center justify-between px-5 app-card flex-shrink-0">
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-full bg-gradient-to-br from-ai-start to-ai-end flex items-center justify-center relative flex-shrink-0">
                        ...
                        <div>
                            <h2 class="font-bold app-text text-sm leading-tight">MovieMate AI</h2>
                ...
                <div class="flex-grow overflow-y-auto p-5 space-y-5 scroll-smooth" id="chat-messages">
                    ...
                    <div class="flex gap-3 max-w-[88%] ml-auto justify-end">
                        ...
                        <div class="w-8 h-8 rounded-full app-secondary flex-shrink-0 overflow-hidden mt-1 border app-border">
                ...
                <!-- Input Area -->
                <div class="p-4 border-t app-border app-secondary flex-shrink-0">
                    <form action="#" class="flex items-end gap-2">
                        <button type="button" class="p-2.5 app-muted hover:app-text transition-colors flex-shrink-0">
                        ...
                        <button type="submit" class="p-2.5 bg-ai-start hover:bg-ai-end text-white rounded-xl transition-colors flex-shrink-0">
